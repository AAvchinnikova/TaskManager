...
declare namespace fastq {
  type worker<C, T = any, R = any> = (this: C, taskStatus: T, cb: fastq.done<R>) => void
  type asyncWorker<C, T = any, R = any> = (this: C, taskStatus: T) => Promise<R>
  type done<R = any> = (err: Error | null, result?: R) => void
  type errorHandler<T = any> = (err: Error, taskStatus: T) => void

  interface queue<T = any, R = any> {
    push(taskStatus: T, done?: done<R>): void
    unshift(taskStatus: T, done?: done<R>): void
    pause(): any
    resume(): any
    running(): number
    idle(): boolean
  ...
  interface queueAsPromised<T = any, R = any> extends queue<T, R> {
    push(taskStatus: T): Promise<R>
    unshift(taskStatus: T): Promise<R>
